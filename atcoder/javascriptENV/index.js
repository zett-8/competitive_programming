...
<head>
	...
	<meta property="og:title" content="F - Range Set Query" />
	...
	<meta property="og:url" content="https://atcoder.jp/contests/abc174/tasks/abc174_f" />
	<meta property="og:image" content="https://img.atcoder.jp/assets/atcoder.png" />
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:site" content="@atcoder" />
	
	<meta property="twitter:title" content="F - Range Set Query" />
...
<div id="main-div" class="float-container">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="/contests/abc174/tasks/abc174_f?lang=ja"><img src='//img.atcoder.jp/assets/top/img/flag-lang/ja.png'> 日本語</a></li>
							<li><a href="/contests/abc174/tasks/abc174_f?lang=en"><img src='//img.atcoder.jp/assets/top/img/flag-lang/en.png'> English</a></li>
						</ul>
					</li>
	...
	<form method="POST" name="form_logout" action="/logout?continue=https%3A%2F%2Fatcoder.jp%2Fcontests%2Fabc174%2Ftasks%2Fabc174_f">
...
<div class="row">
	...
	<ul class="nav nav-tabs">
		<li><a href="/contests/abc174"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> トップ</a></li>
			...
			<li><a href="/contests/abc174/submit?taskScreenName=abc174_f"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> 提出</a></li>
	...
	<div class="col-sm-12">
		<span class="h2">F - Range Set Query</span>
...
<div class="part">
<section>
<h3>問題文</h3><p><var>N</var> 個の色の付いた玉が左右一列に並んでおり、左から <var>i</var> 番目の玉の色は <var>c_i</var> です。</p>
<p>クエリが <var>Q</var> 個与えられます。<var>i</var> 番目のクエリでは、左から <var>l_i</var> 番目から <var>r_i</var> 番目までにある玉の色の種類数を答えてください。</p>
</section>
</div>
...
<ul>
<li><var>1,2,3</var> 番目の玉の色は <var>1,2,1</var> で、色 <var>1,2</var> の <var>2</var> 種類があります。</li>
<li><var>2,3,4</var> 番目の玉の色は <var>2,1,3</var> で、色 <var>1,2,3</var> の <var>3</var> 種類があります。</li>
<li><var>3</var> 番目の玉の色は <var>1</var> で、色 <var>1</var> の <var>1</var> 種類があります。</li>
</ul>
</section>
</div>
...
3
		...
		<form class="form-horizontal form-code-submit" action="/contests/abc174/submit" method="POST">
			<input type="hidden" name="data.TaskScreenName" value="abc174_f" />
...
<div class="a2a_kit a2a_kit_size_20 a2a_default_style pull-right" data-a2a-url="https://atcoder.jp/contests/abc174/tasks/abc174_f?lang=ja" data-a2a-title="F - Range Set Query">
...
const url = 'https://atcoder.jp/contests/abc174/tasks/abc174_f'
...
const main = (input) => {
  ...
  const ans = {}
  const sq = q.slice(0).sort((a, b) => a[0] === b[0] ? a[1] - b[1] : a[0] - b[0])

  while (sq.length) {

    const [start, end] = sq.shift()

    const s = new Set(stones.slice(start-1, end))
    ans[`${start}-${end}`] = s.size

    while (sq[0] && sq[0][0] === start) {
      const [_start, _end] = sq.shift()
      for (let i = end; i < _end; i++) s.add(stones[i])
      ans[`${_start}-${_end}`] = s.size
    }
  }

  for (let [s, e] of q) console.log(ans[`${s}-${e}`])
}
