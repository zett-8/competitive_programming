...
<head>
	...
	<meta property="og:title" content="A - Rainy Season" />
	...
	<meta property="og:url" content="https://atcoder.jp/contests/abc175/tasks/abc175_a" />
	<meta property="og:image" content="https://img.atcoder.jp/assets/atcoder.png" />
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:site" content="@atcoder" />
	
	<meta property="twitter:title" content="A - Rainy Season" />
...
<div id="main-div" class="float-container">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="/contests/abc175/tasks/abc175_a?lang=ja"><img src='//img.atcoder.jp/assets/top/img/flag-lang/ja.png'> 日本語</a></li>
							<li><a href="/contests/abc175/tasks/abc175_a?lang=en"><img src='//img.atcoder.jp/assets/top/img/flag-lang/en.png'> English</a></li>
						</ul>
					</li>
	...
	<form method="POST" name="form_logout" action="/logout?continue=https%3A%2F%2Fatcoder.jp%2Fcontests%2Fabc175%2Ftasks%2Fabc175_a">
...
<div class="row">
	...
	<ul class="nav nav-tabs">
		<li><a href="/contests/abc175"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> トップ</a></li>
			...
			<li><a href="/contests/abc175/submit?taskScreenName=abc175_a"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> 提出</a></li>
...
<div class="part">
<section>
<h3>問題文</h3><p>AtCoder 町の、ある連続した <var>3</var> 日間の天気の記録があります。天気の記録は長さ <var>3</var> の文字列 <var>S</var> で表され、<var>i (1 \\leq i \\leq 3)</var> 日目の天気は <var>i</var> 文字目が <code>S</code> のとき晴れ、<code>R</code> のとき雨でした。</p>
...
<h3>制約</h3><ul>
<li><var>|S| = 3</var></li>
<li><var>S</var> の各文字は <code>S</code> または <code>R</code> である</li>
</ul>
</section>
</div>
...
<div class="part">
<section>
<h3>出力</h3><p>天気が雨である日が連続していた最大の日数を出力せよ。</p>
</section>
</div>
</div>
...
<p><var>3</var> 日間のうち、<var>1, 2</var> 日目が雨で、最大では <var>2</var> 日間雨である日が連続していたので <var>2</var> を出力してください。</p>
</section>
</div>
...
<p><var>3</var> 日間のうち、<var>3</var> 日とも晴れでした。雨である日は無かったため、<var>0</var> を出力してください。</p>
</section>
</div>
...
<p><var>3</var> 日間のうち、<var>1, 3</var> 日目が雨でした。共に <var>1</var> 日雨である日が連続していたので、<var>1</var> を出力してください。</p></section>
</div>
</span>
<span class="lang-en">
...
<p>We had rain on the <var>1</var>-st and <var>3</var>-rd days - two "streaks" of one rainy day, so we should print <var>1</var>.</p></section>
		...
		<form class="form-horizontal form-code-submit" action="/contests/abc175/submit" method="POST">
			<input type="hidden" name="data.TaskScreenName" value="abc175_a" />
...
<div class="a2a_kit a2a_kit_size_20 a2a_default_style pull-right" data-a2a-url="https://atcoder.jp/contests/abc175/tasks/abc175_a?lang=ja" data-a2a-title="A - Rainy Season">
...
const url = 'https://atcoder.jp/contests/abc175/tasks/abc175_a'
